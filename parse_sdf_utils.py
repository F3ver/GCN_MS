...
def get_sdf_to_mol(
    ...
    max_atom_degree=ms_constants.MAX_ATOM_DEGREE,
    max_atom_implicit_hydrogen=ms_constants.MAX_ATOM_NUM_HS,
    max_atom_implicit_valence=ms_constants.MAX_ATOM_IMPLICIT_VALENCE):
    ...
    def _mol_passes_filters(mol):
        ...
        filter_list.append(max(feature_utils.get_degree(mol)) <= max_atom_degree)
        filter_list.append(all(feature_utils.get_degree(mol)))
        filter_list.append(feature_utils.get_largest_implicit_hydrogen_atoms(mol) <= max_atom_implicit_hydrogen)
        filter_list.append(feature_utils.get_largest_implicit_valence(mol) <= max_atom_implicit_valence)
