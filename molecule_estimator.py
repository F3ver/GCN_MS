...
FLAGS = flags.FLAGS
flags.DEFINE_string(
    'dataset_config_file', './tmp/output_dataset_dir/query_replicates_test_predicted_replicates_test.json',
...
flags.DEFINE_string('model_dir', './tmp/models/output',
...
flags.DEFINE_enum('model_type', 'gcn',
...
def make_input_fn(dataset_config_file,
    ...
    if load_library_matching_data:
        ...
        def _wrapped_input_fn():
            ...
            return {fmap_constants.SPECTRUM_PREDICTION: _input_fn(
